...
mod tests {
    ...
    // --- pre_lock_prefix sticky tests live in startup::tests (FEAT-002b) ---
    // Legacy "read JSON taskPrefix / bare generate_prefix" helpers are no longer
    // the pre_lock path; identity → resolve_sticky_prefix is the SSoT.
