...
fn classify_drained_queue(conn: &Connection, task_prefix: Option<&str>) -> Option<DrainedOutcome> {
...
mod tests {
    ...
    mod wave {
        ...
        use crate::loop_engine::test_utils::{
            get_task_status, insert_relationship, insert_task, insert_task_file,
        };
