...
fn clamp_weight(value: i32, default: i32) -> i32 {
...
fn clamp_negative_weight(value: i32, default: i32) -> i32 {
...
fn compute_correlation<F>(outcomes: &[TaskOutcome], dimension: F) -> f64
where
...
fn adjust_weight(default: i32, correlation: f64, factor: f64) -> i32 {
...
mod tests {
    ...
    // --- AC: Exactly at weight bounds (0.5x and 2.0x) ---
    ...
    // --- AC: Zero default weight handling ---
    ...
    // --- AC: adjust_weight with max correlation ---
    ...
    // --- AC: Correlation with equal means ---
    ...
    // --- AC: Synergy dimension correlation ---
    ...
    // --- AC: Conflict dimension correlation ---
