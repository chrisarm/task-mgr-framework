...
const ITERATION_HEADROOM_MULTIPLIER: f64 = 1.25;
...
///
/// The 1.25 multiplier provides ~25% headroom for reorders, retries,
...
mod tests {
    ...
    fn test_permission_mode_variants_distinct() {
        assert_ne!(PermissionMode::Dangerous, PermissionMode::Auto);
        assert_ne!(
